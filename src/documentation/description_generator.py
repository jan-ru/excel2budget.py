...
Requirements: 17.3.1–17.3.3, 17.4.1–17.4.3, 17.5.1–17.5.3
"""
...
def generate_input_description(context: ApplicationContext) -> DocumentArtifact:
    ...
    Describes the source data structure: column names, types,
...
def generate_output_description(context: ApplicationContext) -> DocumentArtifact:
    ...
    Describes the target output structure: column names, types,
    ordering, and fixed values.
    """
...
def generate_transform_description(context: ApplicationContext) -> DocumentArtifact:
    ...
    Describes the transformation logic: unpivot, DC split,
    column renaming, and the generated SQL.
    """
